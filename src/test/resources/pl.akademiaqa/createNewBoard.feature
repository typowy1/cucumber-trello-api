Feature: Create new board
  ...
  @cleanup
  Scenario Outline: I should be able to create new board with special chars as a board
    Given I am authenticated to Trello
  ...
  @cleanup
  Scenario: I should be able to create new board with empty board name
    Given I am authenticated to Trello
    When I try to create board with empty board name
    Then I should see an error

  @cleanup
  Scenario: I should be able to create new board when not authenticated
